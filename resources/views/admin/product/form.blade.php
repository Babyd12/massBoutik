<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            <label for="purchace_price" class="form-label">{{ __('messages.Purchase price') }}</label>
        ...
        <div class="form-group mb-2 mb20">
            <label for="wholesale_price" class="form-label">{{ __('messages.Wholesale price') }}</label>
            <input type="text" name="wholesale_price" class="form-control @error('wholesale_price') is-invalid @enderror" value="{{ old('wholesale_price', $product?->wholesale_price) }}" id="purshace_price" placeholder="wholesale_price">
            {!! $errors->first('wholesale_price', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
            <label for="selling_price" class="form-label">{{ __('messages.Selling price') }}</label>
