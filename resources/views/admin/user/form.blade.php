<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="full_name" class="form-control is-valid  @error('full_name') is-invalid @enderror  " value="{{ old('full_name', $user?->full_name) }}" id="full_name" placeholder="Full Name">
        ...
        <div class="form-group mb-2 mb20">
            <label for="role" class="form-label">{{ __('messages.This field is ') }}</label>
            <input type="text" name="role" class="form-control @error('role') is-invalid @enderror" value="{{ old('role', ) App\Enums\Role::Custumer  }}" id="role" placeholder="Role">
            {!! $errors->first('role', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
            <label for="phone" class="form-label">{{ __('messages.Phone') }}</label>
            <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" value="{{ old('phone', $user?->phone_id) }}" id="phone_id" placeholder="Phone Id">
